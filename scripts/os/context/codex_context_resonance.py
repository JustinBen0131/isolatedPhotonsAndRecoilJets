...
CANARY_TASKS = [
    ...
    {
        "id": "slide_regression_prevention",
        "task": "generate a polished full-slide PNG candidate and speaker script without regressing to prior slide style issues",
        "route": "slide_scripting",
        "expected_any": {
    ...
    {
        "id": "slide_feedback_ingestion",
        "task": "fix the slide I just generated and make sure the same mistake does not happen again",
        "route": "slide_scripting",
        "expected_any": {
    ...
    {
        "id": "training_duplicate_guard",
        "task": "run a new AuAu BDT training with these settings",
        "route": "training_production",
        "expected_any": {"duplicate_run_guard_before_training", "no_duplicate_training_without_guard"},
    },
    {
        "id": "task_capture",
        "task": "add this to the task list",
        "route": "task_capture",
        "expected_any": {"task_capture_register_first", "no_task_capture_chat_only"},
    },
    {
    ...
    },
    {
        ...
        "task": "nightly dream should prevent recurring slide formatting regressions",
        "route": "os_maintenance",
        "expected_any": {
    ...
    {
        "id": "dream_promotion_gate",
        "task": "promote recurring dream finding into validated policy or doctor check",
        "route": "os_maintenance",
        "expected_any": {
            "dream_learning_atom_schema",
            "dream_promotion_protocol_schema",
    ...
    {
        "id": "thesis_fastest_safe_next",
        "task": "what should I do next to close the thesis fastest without sacrificing physics accuracy",
        "route": "os_maintenance",
        "expected_any": {
    ...
    {
        "id": "novel_ml_vs_baseline",
        "task": "should I pursue novel ML or finish the minimal publishable AuAu gamma-jet baseline first",
        "route": "training_production",
        "expected_any": {
            "minimal_publishable_path_before_novelty",
    ...
    {
        "id": "xjgamma_slide_finitude",
        "task": "generate a thesis-facing xJgamma slide without wasting time or repeating old formatting mistakes",
        "route": "slide_scripting",
        "expected_any": {
            "thesis_finitude_care_kernel",
    ...
    {
        "id": "dream_speculative_physics_gate",
        "task": "nightly dream finds a speculative physics idea but the baseline result is not safe",
        "route": "os_maintenance",
        "expected_any": {
