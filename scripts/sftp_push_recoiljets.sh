...
LOCAL_FILES=(
  ...
  "scripts/audit_auau_truth_tags.py"
  "scripts/auau_tight_bdt_pipeline.sh"
  "scripts/auau_tight_logreg_pipeline.sh"
  "scripts/auau_tight_mlp_pipeline.sh"
  "scripts/pp_photon_ml_pipeline.sh"
  "scripts/build_currentian_fast_manifests.py"
  "scripts/compare_pp_currentian_insitu_stitch_contract.py"
  "scripts/make_pp_currentian_insitu_contract_stitch_slides.py"
  "scripts/make_ppg12_fig19_bdt_overlay.py"
  "scripts/audit_pp_basev3e_shuhang_equivalence.py"
  "scripts/render_pp_currentian_shuhang_overlay_from_summary.py"
  "scripts/validate_pp_photon_ml_tables.py"
  "scripts/submit_auau_logreg_full_chain.sh"
  "scripts/estimateEmbeddedPhotonXsec.sh"
  "scripts/extract_focus21_fine_cluster_et_components.py"
  "scripts/make_focus21_cluster_et_leakage_slide.py"
  "scripts/make_focus21_inclusive_reco_cluster_et_blair_plot.py"
  ...
  "scripts/submit_auau_bdt_widthstudy_pt1530_wp080.sh"
  "scripts/submit_auau_bdt_widthstudy_windows_wp050.sh"
  "scripts/merge_auau_bdt_widthstudy_windows_wp050_staged.sh"
  "scripts/merge_auau_bdt_target80_ready.sh"
  "scripts/submit_auau_bdt_etfine_centstudy_wp050.sh"
  "scripts/submit_auau_bdt_etfine_centstudy_target80.sh"
  ...
  "scripts/submit_auau_mlp_targetwp_pair.sh"
  "scripts/submit_auau_mlp_highpt_sweep.sh"
  "scripts/submit_auau_mlp_kitchensink.sh"
  "scripts/submit_auau_mlp_finept_distilled_sweep.sh"
  "scripts/submit_auau_stacked_bdt_mlp_calibrator.sh"
  "scripts/submit_auau_stacked_bdt_mlp_full_feature_chain.sh"
  "scripts/submit_auau_stacked_bdt_mlp_sweep.sh"
  "scripts/submit_auau_stack_matrix_wave.sh"
  "scripts/submit_auau_iso_visible_diagnostic_chain.sh"
  "scripts/submit_auau_oof_residual_superstacker.sh"
  "scripts/submit_auau_global_sixpack_oof_stack.sh"
  "scripts/auau_bdt_mlp_stack_production_driver.sh"
  "scripts/promote_auau_stacked_bdt_mlp.py"
  "scripts/make_auau_bdt_training_closure.py"
  "scripts/make_auau_bdt_mlp_stack_roc_overlay.py"
  "scripts/make_auau_bdt_mlp_stack_score_separation.py"
  "scripts/make_auau_mlp_expert_validation_plots.py"
  "scripts/make_auau_mlp_training_curves.py"
  "scripts/make_auau_stacked_training_curves.py"
  "scripts/make_auau_iso_visible_diagnostic_summary.py"
  "scripts/make_auau_isolation_feature_correlations.py"
  "scripts/train_auau_stacked_bdt_mlp_calibrator.py"
  "scripts/train_auau_stacked_bdt_mlp_sweep.py"
  "scripts/train_auau_oof_residual_superstacker.py"
  "scripts/auau_mlp_bdt_beating_driver.sh"
  "scripts/prepare_auau_bdt_target80_available_campaigns.sh"
  "scripts/make_auau_bdt_target_wp_config.py"
  "scripts/make_auau_logreg_target_wp_config.py"
  "scripts/make_auau_mlp_target_wp_config.py"
  ...
  "macros/analysis_config_auau_bdt_mlp_stack_wp080.yaml"
