...
THRESHOLD_SPECS = {
    ...
    "code_config": ThresholdSpec(
        name="code_config",
        tight_intercept=0.8333333333333334,
        tight_slope=-0.003333333333333336,
        nontight_min_intercept=0.7333333333333333,
        nontight_min_slope=-0.01333333333333333,
        nontight_max_intercept=0.6666666666666666,
        nontight_max_slope=0.003333333333333336,
    ),
    # Table 5 in current PPG12 IAN v4 and PRD draft v0p5.
    "current_ian": ThresholdSpec(
        name="current_ian",
        tight_intercept=0.8156,
        tight_slope=-0.00156,
        nontight_min_intercept=0.7333,
        nontight_min_slope=-0.01333,
        nontight_max_intercept=0.6844,
        nontight_max_slope=0.00156,
    ),
}
...
def main() -> int:
    ...
    for bin_idx in range(len(PT_BINS) - 1):
        ...
        record: dict[str, Any] = {
            ...
            "stored_score_current_ian_tight_common": ratio(bucket["stored_score_current_ian_tight"], common),
            "stored_score_current_ian_nontight_common": ratio(bucket["stored_score_current_ian_nontight"], common),
            "stored_score_current_ian_neither_common": ratio(bucket["stored_score_current_ian_neither"], common),
            ...
            "selected_score_current_ian_tight_common": ratio(bucket["selected_score_current_ian_tight"], common),
            "selected_score_current_ian_nontight_common": ratio(bucket["selected_score_current_ian_nontight"], common),
            "selected_score_current_ian_neither_common": ratio(bucket["selected_score_current_ian_neither"], common),
    ...
    preferred = [
        ...
        "stored_score_current_ian_nontight_common",
        "selected_score_code_config_nontight_common",
        "selected_score_current_ian_nontight_common",
        "stored_tight_common",
        "stored_score_code_config_tight_common",
        "stored_score_current_ian_tight_common",
        "selected_score_code_config_tight_common",
        "selected_score_current_ian_tight_common",
        "stored_neither_common",
        "stored_score_code_config_neither_common",
        "stored_score_current_ian_neither_common",
        "selected_score_code_config_neither_common",
        "selected_score_current_ian_neither_common",
        "mean_stored_score",
        "mean_base_e_score",
        "mean_base_v3e_score",
        "mean_selected_score",
    ...
    lines = [
        ...
        "It then compares the old PPG12 code/YAML BDT threshold constants against the current IAN/PRD Table 5 thresholds.",
        "",
        "| pT bin | common | actual RJ NT/common | stored score + code NT/common | stored score + IAN NT/common | recomputed score + code NT/common | recomputed score + IAN NT/common | actual RJ tight/common | stored score + IAN tight/common | recomputed score + IAN tight/common | selected base_E rows |",
        "| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |",
    ]
    for record in records:
        lines.append(
            "| {pt_bin} | {common} | {stored_nt:.4f} | {stored_code_nt:.4f} | {stored_ian_nt:.4f} | {sel_code_nt:.4f} | {sel_ian_nt:.4f} | {stored_t:.4f} | {stored_ian_t:.4f} | {sel_ian_t:.4f} | {base_e} |".format(
                ...
                stored_ian_nt=record["stored_score_current_ian_nontight_common"],
                sel_code_nt=record["selected_score_code_config_nontight_common"],
                sel_ian_nt=record["selected_score_current_ian_nontight_common"],
                stored_t=record["stored_tight_common"],
                stored_ian_t=record["stored_score_current_ian_tight_common"],
                sel_ian_t=record["selected_score_current_ian_tight_common"],
