...
Full-scope extraction requires a `THE134_SOURCE_PROVENANCE_V1` JSON that pins
...
application, and exact declared component product).  A required source with zero
15--35 GeV rows is accepted only through a source-complete
