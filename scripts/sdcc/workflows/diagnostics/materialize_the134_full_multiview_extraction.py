...
EXPECTED_CONDOR_MAX_MATERIALIZE = int(
    resolver.SUBMIT_HOST_SAFETY_ENVIRONMENT["RJ_CONDOR_MAX_MATERIALIZE"]
)
EXPECTED_CONDOR_MAX_IDLE = int(
    resolver.SUBMIT_HOST_SAFETY_ENVIRONMENT["RJ_CONDOR_MAX_IDLE"]
)
EXPECTED_LOGIN_PATH_VALIDATION_LINES = int(
    resolver.SUBMIT_HOST_SAFETY_ENVIRONMENT["RJ_VALIDATE_SIM_INPUT_MAX_LINES"]
)
