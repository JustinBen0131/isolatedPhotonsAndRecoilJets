...
process_ready_config() {
  ...
  tag="${group}_${name}"
  signal_bulk="$(rj_bulk_signal_root_for_campaign target_wp "$tag")"
  background_bulk="$(rj_bulk_background_root_for_campaign target_wp "$tag")"
  merge_base="$(rj_merge_root_for_campaign "$tag")"
