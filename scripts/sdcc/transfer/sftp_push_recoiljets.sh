...
LOCAL_FILES=(
  ...
  "scripts/sdcc/workflows/diagnostics/build_the134_capacity_count_amendment.py"
  "scripts/sdcc/workflows/diagnostics/build_the134_capacity_partition_binding.py"
  "scripts/sdcc/workflows/diagnostics/build_the134_controller_dry_materialization_budget.py"
  ...
  "scripts/sdcc/workflows/diagnostics/build_the134_immutable_bundle_receipt.py"
  "scripts/sdcc/workflows/diagnostics/materialize_the134_immutable_bundle.py"
  "scripts/sdcc/workflows/diagnostics/build_the134_ana560_calo_reco_runtime.sh"
  "scripts/sdcc/workflows/diagnostics/contracts/the134_ana560_calo_reco_abi_additions.allowlist"
  "scripts/sdcc/workflows/diagnostics/the134_full_extraction_controller.py"
  "scripts/sdcc/runtime/control/launch_supervised_remote_phase.sh"
  "scripts/ml/contracts/__init__.py"
  "scripts/ml/contracts/the134_h70_contract.py"
  "scripts/ml/training/prepare_the134_h70_matrix.py"
  "scripts/ml/training/run_the134_h70_model.py"
  "scripts/ml/validation/audit_the134_model_reuse.py"
  "scripts/ml/validation/materialize_the134_h70_holdout.py"
  "scripts/ml/validation/validate_the134_h70_model.py"
  "scripts/ml/validation/build_the134_h70_model_registry.py"
  "scripts/ml/validation/the134_aggregate_contract.py"
  "scripts/ml/validation/build_the134_science_freeze_certificate.py"
  "scripts/ml/validation/project_the134_storage_quota.py"
  "scripts/ml/validation/build_the134_source_complete_replay_certificates.py"
  "scripts/ml/validation/assemble_the134_science_freeze_manifest.py"
  "scripts/ml/working_points/materialize_the134_h70_wp_sample.py"
  "scripts/ml/working_points/derive_the134_h70_wp.py"
  "scripts/diagnostics/replay_foundation/validate_the134_shower_factorial.py"
  "scripts/diagnostics/replay_foundation/validate_the134_training_sidecar.py"
  "scripts/diagnostics/replay_foundation/validate_the134_sidecar_differential.py"
  "scripts/diagnostics/replay_foundation/validate_the119_jet_response.py"
  ...
  "macros/analysis_config_the119_pp_replay_foundation.yaml"
...
add_group() {
  ...
  case "$group" in
    ...
    pipeline|all)
      ...
      add_local_rel "src/RJPhotonTrainingViewV1.h"
