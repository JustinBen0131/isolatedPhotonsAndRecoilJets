...
def require_imports():
    try:
        ...
        raise SystemExit(
            "MLP validation needs numpy and uproot. Use "
...
def derive_working_points(frame, scores, product_specs, target: float):
    import numpy as np
...
def main() -> int:
    ...
    if args.derive_working_points_from_report:
        ...
        manifest = derive_working_points(frame, scores, product_specs, args.target_signal_efficiency)
    ...
    wp_manifest = derive_working_points(frame, scores, product_specs, args.target_signal_efficiency)
