...
def main() -> None:
    ...
    band.text(
        0.125,
        0.62,
        f"Global full-stat AUC drops: 90/10 = {aucs['90/10']:.3f}, 50/50 = {aucs['50/50']:.3f}, 10/90 = {aucs['10/90']:.3f}.",
        fontsize=12.4,
        color=INK,
        ha="left",
        va="center",
    ...
    band.text(
        0.125,
        0.25,
        f"Within centrality bins, AUC changes only {min_cent_delta:+.3f} to {max_cent_delta:+.3f}; small upward shifts can mean variance/composition, not proof that less training data is better.",
        fontsize=10.9,
        color=MUTED,
        ha="left",
        va="center",
