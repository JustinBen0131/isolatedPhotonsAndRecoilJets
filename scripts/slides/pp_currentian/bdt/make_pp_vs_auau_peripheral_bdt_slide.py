...
def make_slide(pp: dict[str, object], auau: dict[str, object]) -> None:
    ...
    def box(
        ...
        *,
        ...
        fig.text(x + xpad, y + h - title_offset, title, fontsize=18, weight="bold", color=INK, va="top")
    ...
    box(
        ...
        0.135,
        "Interpretation",
        "This checks pp and peripheral AuAu photon-ID ranking shapes in the same 15-35 GeV ET window.\nROC values show both classifiers remain strongly separating.",
        GREEN_BG,
        GREEN_EDGE,
        wrap=82,
        xpad=0.012,
    ...
    box(
        ...
        0.135,
        "Caveat",
        "Apples-to-apples ET-window comparison; remaining differences are sample environment and training contract.\npp raw-inclusive full simulation versus AuAu embedded Branch A validation.",
        AMBER_BG,
        AMBER_EDGE,
        wrap=82,
        xpad=0.012,
