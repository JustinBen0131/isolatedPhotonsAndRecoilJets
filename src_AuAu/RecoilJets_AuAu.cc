          ...
          else
          {
           ...
           // -------------------------------------------------------------------------
            ...
            if (m_evtDiagEnabled)
            {
              ...
              {
                  const bool isSimED = m_isSim;

                  const double diagPt  = (isSimED ? tPt  : leadPtGamma);
                  const double diagPhi = (isSimED ? tPhi : leadPhiGamma);
                  const double diagEta = (isSimED ? tEta : leadEtaGamma);
