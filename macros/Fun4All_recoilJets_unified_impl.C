                                     ...
                                     const bool  verbose   = false)
{
  ...
  {
    detail::bail("clusterUEpipeline=true requires the native-EMCal UE subtraction module and PhotonClusterBuilder node-plumbing patch before it can run safely.");
  }
